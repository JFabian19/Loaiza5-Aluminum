...
import { Check, ShieldCheck, ThumbsUp, MessageSquare, ArrowRight, Phone, Star, Quote } from 'lucide-react';
      ...
      <section className="relative h-[600px] flex items-center justify-center text-white overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center md:text-left w-full">
          <div className="md:w-2/3 lg:w-1/2 space-y-6">
            <div className="inline-block bg-accent/90 px-3 py-1 rounded-full text-sm font-semibold tracking-wide uppercase mb-2">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative h-[500px] rounded-2xl overflow-hidden shadow-2xl">
              <img src="/image_4.jpg" alt="Loaiza5 Professional Installation" className="w-full h-full object-cover" />
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-4xl mx-auto relative bg-cream rounded-2xl p-8 md:p-12 shadow-sm border border-gray-100">
            ...
            <div className="relative overflow-hidden min-h-[220px] flex items-center justify-center">
              {TESTIMONIALS.map((testimonial, index) => (
                <div 
                  key={testimonial.id}
                  className={`absolute inset-0 transition-opacity duration-500 ease-in-out flex flex-col items-center justify-center text-center px-4 ${
